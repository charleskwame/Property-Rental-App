export const ReservationEmailClient = (username, property, date, time, ownername) => {
    ...
    <table style="font-family:helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; line-height: 140%;  text-align: left; word-wrap: break-word;">
        <p dir="ltr"><span>Your request to view </span><span style="font-weight: bold;">${property}</span><span>, on </span><span style="font-weight: bold;">${date}</span><span> at </span><span style="font-weight: bold;">${time} </span><span>has been sent to </span><span style="font-weight: bold;">${ownername}. </span></p>
      </div>
