export const ReservationUpdateClientAccepted = (username, propertyname, date, time) => {
    ...
    <table style="font-family:helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; line-height: 140%;  text-align: left; word-wrap: break-word;">
        <p dir="ltr"><span>Your request to view </span><span style="font-weight: bold;">${propertyname}</span><span> on </span><span style="font-weight: bold;">${date}</span><span> at </span><span style="font-weight: bold;">${time}</span><span> has been accepted</span><span style="font-weight: bold;">. </span></p>
      </div>
...
export const ReservationUpdateClientRejected = (username, propertyname) => {
	return `<!DOCTYPE HTML
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:helvetica,sans-serif;"
                                                                ...
                                                                <div
                                                                    style="font-size: 14px; line-height: 140%;  text-align: left; word-wrap: break-word;">
                                                                    <p dir="ltr"><span>Your request to view </span><span
                                                                            style="font-weight: bold;">${propertyname}</span><span>
                                                                            has been rejected by the owner</span><span
