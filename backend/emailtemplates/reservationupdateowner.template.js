export const ReservationUpdateOwner = (ownername, status, username, propertyname, date, time) => {
    ...
    <table style="font-family:helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; line-height: 140%;  text-align: left; word-wrap: break-word;">
        <p dir="ltr"><span>You have a ${status} a reservation made by ${username} for your property ${propertyname} on ${date} at ${time}</span><span style="font-weight: bold;">. </span></p>
      </div>
