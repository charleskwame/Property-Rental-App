export const ReservationEmailOwner = (ownername, propertyname, username, date, time) => {
    ...
    <table style="font-family:helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; line-height: 140%;  text-align: left; word-wrap: break-word;">
        <p dir="ltr"><span>Hello </span><span style="color: rgb(138, 1, 148); font-weight: bold;">${ownername}</span><span>,</span></p>
      </div>
    ...
    <table style="font-family:helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; line-height: 140%;  text-align: left; word-wrap: break-word;">
        <p dir="ltr"><span>You have a request to view your property "${propertyname}" from ${username} on ${date} at ${time}</span><span style="font-weight: bold;">. </span></p>
      </div>
    ...
    <table style="font-family:helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; line-height: 140%;  text-align: left; word-wrap: break-word;">
        <p dir="ltr"><span>You can accept / decline the request from your dashboard/manage reservations.</span></p>
      </div>
    ...
    <table style="font-family:helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; line-height: 140%;  text-align: left; word-wrap: break-word;">
        <p dir="ltr"><span>An update will be sent after your take action.</span></p>
      </div>
